...
Data is first loaded from saved file or scraped and saved locally as a sort of cache. 
Player stats are merged with schedule stats based on season, week, and home/away team.
...
*K and P stats are unavailable reliably so we exclude them.
